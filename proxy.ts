...
export async function proxy(request: NextRequest) {
  ...
  const publicRoutes = ["/", "/login", "/auth/callback", "/api/macro", "/api/commodities", "/api/news", "/api/sentiment", "/api/paper/cron", "/api/snapshots/cron", "/api/corporate-actions/cron", "/api/reports/cron", "/api/analysis/portfolio-snapshots/cron", "/api/calendar/ics"];
